    ...
    jsMind.draggable.prototype = {
        ...
        dragstart: function (e) {
            ...
            if (!!nodeid) {
                ...
                if (!node.isroot) {
                    ...
                    // this.offset_x = (e.layerX || e.touches[0].layerX) - el.offsetLeft;
                    // this.offset_y = (e.layerY || e.touches[0].layerY) - el.offsetTop;
        ...
        drag: function (e) {
            ...
            if (this.capture) {
                ...
                // var px = (e.layerX || e.touches[0].layerX) - this.offset_x;
                // var py = (e.layerY || e.touches[0].layerY) - this.offset_y;
